...
echo>> ..\config.h #define CONFIG_TCC_PREFIX "%PX%-"
echo>> ..\config.h #define CONFIG_TCC_CROSSPREFIX "%P%-"
echo>> ..\config.h #else
echo>> ..\config.h #define CONFIG_TCC_PREFIX "%P%-"
...
%CC% -o x-tcc.exe ..\tcc.c %EXOBJ% libtcc.dll %D% -DONE_SOURCE"=0"
...
:lib
call :make_lib %T% %P%- || goto :the_end
